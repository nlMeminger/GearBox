...
class App(QMainWindow):
    ...
    def __init__(self):
        ...
        self.initUI()
        self.mediaDevice = dbus_audio_control.mediaControl("A0:56:F3:60:8C:D8")
    ...
    def playhandler(self):
        self.mediaDevice.play()
        self.userAction = 1

    def pausehandler(self):
        self.userAction = 2
        self.mediaDevice.pause()
    ...
    def prevSong(self):
        ...
        self.mediaDevice.previous()
    
    def shufflelist(self):
        self.playlist.shuffle()

    def nextSong(self):
        self.mediaDevice.next()
